...
**10 concepts · 54 links.** Curated, leak-free reference for the methods this repo actually uses. Fundamentals are written once and only updated when our methods change — they are not re-researched on a schedule.
